    ...
    <main className="min-h-screen  pb-16">
      ...
      <section className="pt-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="relative z-20 mb-14 group">
          <div className="flex items-center gap-6 text-center justify-center">
            ...
            <div className="relative flex-grow h-[1.5px] bg-gray-200/80 max-md:hidden overflow-hidden">
              <div
          ...
          <p
            className={` ${currenttext} text-center max-md:text-sm text-lg mb-6 p-3`}
          >
      ...
      <section className="pt-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="relative z-20 mb-14 group">
          <div className="flex items-center gap-6 text-center justify-center">
            {/* Left divider - enhanced */}
            <div className="relative flex-grow h-[1.5px] bg-gray-200/80 overflow-hidden max-md:hidden">
              <div
                className={`absolute left-0 top-0 w-10 h-full ${currentAccent} transform -translate-x-full group-hover:translate-x-[calc(100vw+20px)] transition-transform duration-900 ease-[cubic-bezier(0.19,1,0.22,1)]`}
              ></div>
              <div
          ...
          <p
            className={` ${currenttext} text-center text-lg max-md:text-sm mb-6 p-3`}
          >
            {theme[season].description}
          </p>
