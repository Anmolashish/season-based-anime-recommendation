...
const Jagjeet = (props) => {
  ...
  return (
    <div className={`min-h-screen ${SEASONS[currentSeason].bgColor} overflow-x-hidden relative font-['Poppins'] leading-6`}>
      <Head>
...
>
  ...
  <div
    ...
    style={{ backgroundImage: `url(${SEASONS[currentSeason].bgImage})` }}
  ></div>
  ...
  <div className="relative z-20 p-8 rounded-xl bg-white/15 backdrop-blur-[5px] flex flex-col items-center gap-6">
    <h1 id="season-heading" className="text-[clamp(2rem,5vw,3.5rem)] mb-2 font-bold leading-[1.2] text-[#e3eaf5]">
      Anime Through the Seasons
    </h1>
    <p className="text-md text-[#e3eaf5] font-light leading-[1.6] max-w-[700px] mx-auto italic">
      Experience the magic of anime in {SEASONS[currentSeason].name.toLowerCase()} – {SEASONS[currentSeason].description}.
    </p>
